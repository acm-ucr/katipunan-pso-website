    ...
    <>
      ...
      <div className="relative overflow-hidden">
        ...
        <p className="font-inria-serif text-md mx-10 mt-15 inline-block justify-center text-center leading-12 md:text-lg lg:mx-30 lg:text-xl xl:mx-70">
          ...
          is heavily influenced by the Spanish during its colonization period
          from the 1500s to the 1800s. Dances from this suite represent the
          wealthy mestizas and mestizos (those of mixed Philippine and Spanish
          heritage) of the Philippines, capturing their elegance and boldness.
          As the dancers perform with a smile and confidence, they tell a story
          of courtship, love, and flirtation. The dances were heavily influenced
          by colonization and still encapsulate the native flare and style of
          the Philippines.
        </p>
