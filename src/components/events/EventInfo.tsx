const EventInfo = () => {
  return (
    <div className="font-inria-serif mt-10 flex flex-col items-center justify-center gap-4 px-20 xl:mt-40 xl:px-40">
      <div className="text-kpso-blue mb-8 text-center text-4xl xl:text-6xl">
        WHAT IS THE PAMILYA PROGRAM?
      </div>
      <div className="text-md text-center sm:text-xl sm:leading-[50px] xl:text-2xl xl:leading-[70px]">
